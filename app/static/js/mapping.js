...
source.on('addfeature', function(evt) {
    ...
    let coordinates = this_feature.getGeometry().getCoordinates();
    let this_polygon = new ol.geom.Polygon(coordinates);
    let area = Math.round(this_polygon.getArea() * 10) / 10;

    console.log(this_polygon.transform(current_projection, new_projection).getCoordinates());
